  ...
  Widget _body() {
    return Column(
      children: <Widget>[
        ...
        btn.bootonContinuar('Agregar', _registrarTarjeta)
      ],
    );
  }
  ...
  Widget _contenido() {
    return Container(
      ...
      child: Column(
        children: <Widget>[
          SizedBox(height: 5.0),
          prs.titulo('AGREGAR MÉTODO DE PAGO'),
          prs.subTitulo('Agrega tarjetas de crédito o débito para realizar pagos de forma segura dentro del app.',),
          ...
          Form(
            ...
            child: Column(
              children: <Widget>[
                prs.labels('Nombre completo'),
                SizedBox(height: 10,),
                _crearNombres(),
                SizedBox(height: 20.0),
                prs.labels('Número de la tarjeta'),
                SizedBox(height: 10,),
                _crearNumero(),
                SizedBox(height: 20.0),
                Row(
                  children: [
                    prs.labels('Fecha de vencimiento'),
                    Expanded(child: Container()),
                    prs.labels('Código de seguridad'),
                  ],
                ),
                SizedBox(height: 10,),
                Row(
  ...
  Widget _crearMes() {
    return Container(
      ...
      child: TextFormField(
        maxLength: 2,
        keyboardType: TextInputType.number,
        decoration: prs.decoration('MM', null),
        onSaved: (value) {
  ...
  Widget _crearAnio() {
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: prs.decoration('AA', null),
        validator: (value) {
