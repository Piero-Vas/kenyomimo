...
class _VentasPageState extends State<VentasPage> {
  ...
  _confirmarConvertirDespachador() {
    ...
    dlg.mostrar(context,
        'Presione ACEPTAR solo si esta seguro de querer convertir al usuario ${_cliente.nombres} en un Despachado Mimo y haya recibido el pago previo acordado.',
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
              suffixIcon: IconButton(
                ...
                onPressed: () async {
                  dlg.mostrar(context,
                      'Con Mimo Money puedes pagar el costo o parte del costo de entrega. \n\nAl invitar a tus amigos a usar Mimo tienes mayor probabilidad de obtener money.',
                      titulo: 'Mimo Money');
                },
              ),
              hintText: 'Mimo Money',
              labelText: 'Mimo Money',
              icon: prs.iconoMoney),
        ),
      ),
    );
