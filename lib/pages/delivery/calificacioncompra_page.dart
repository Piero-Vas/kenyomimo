...
class _CalificacioncompraPageState extends State<CalificacioncompraPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Calificar compra',style: TextStyle(color: Colors.black),), leading: SizedBox(),),
      key: _scaffoldKey,
  ...
  _calificar() async{
    ...
    Map<String, dynamic> agency = await _compraProvider.obtenerAgencia(cajeroModel.idSucursal.toString());
    double P = agency['promedioCalificacion']==null ? 0.0 : agency['promedioCalificacion'];
    int N = agency['numeroVeces'] ==null ? 1 : agency['numeroVeces'] +1;
    double calificacion = double.parse(cajeroModel.calificacionCliente.toString());
    double promedioDouble = ((( P*(N-1))+ calificacion )/N);
    Map<String, dynamic> data = {
      "promedioCalificacion": promedioDouble,
      "numeroVeces": N
    };
    bool success = await _compraProvider.actualizarAgencia(cajeroModel.idSucursal.toString(), data);
