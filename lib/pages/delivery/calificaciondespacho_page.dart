...
class _CalificaciondespachoPageState extends State<CalificaciondespachoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text('Calificar despacho',style: TextStyle(color: Colors.black)), leading: SizedBox(),),
      key: _scaffoldKey,
  ...
  _calificar() {
    ...
    _despachoProvider.calificar(despachoModel,
      ...
      // Navigator.of(context).pushAndRemoveUntil(
      //       MaterialPageRoute(builder: (context) => CatalogoPage(isDeeplink: true,)),
      //       (Route<dynamic> route) {
      //     return false;
      //   });
    });
