...
class _DireccionesPageState extends State<DireccionesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ModalProgressHUD(
        ...
        inAsyncCall: _saving,
        child: Center(
            child: Container(child: _body(), padding: EdgeInsets.all(20), width: prs.anchoFormulario, decoration: BoxDecoration(color: Colors.white),)),
      ),
    );
  }
  ...
  Widget _body() {
    return Column(
      children: <Widget>[
        prs.titulo('DIRECCIONES'),
        prs.subTitulo('Administra tus direcciones guardadas.'),
        SizedBox(height: 20,),
        Visibility(
        ...
        children: [ SlidableAction(
          ...
          onPressed: (context) {
            if(direccionModel.idDireccion==-1){
              utils.mostrarSnackBar(context, "La direccion no puede ser eliminada",milliseconds: 2000000);
              return;
            } 
            ...
            dlg.mostrar(context, 'Esta acción no se puede revertir!', fBotonIDerecha: _enviarCancelar, mBotonDerecha: 'ELIMINAR');
          },
        )]),
      );
  }
