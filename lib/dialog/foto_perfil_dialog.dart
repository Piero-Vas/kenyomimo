...
class FotoPerfilDialog extends StatefulWidget {
  ...
  FotoPerfilDialogState createState() => FotoPerfilDialogState(cliente: cliente);
}
...
class FotoPerfilDialogState extends State<FotoPerfilDialog>
  ...
  _cambiarFoto() async {
    _nombreImagen = '${cliente.idCliente.toString()}-${DateTime.now().microsecondsSinceEpoch.toString()}.jpg';
    ...
    _prefs.imagen = '${Sistema.storage}$img?alt=media';
    _fotoBloc.fotoSink(true);
