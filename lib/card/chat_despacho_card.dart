...
class ChatDespachoCard extends StatelessWidget {
  ChatDespachoCard(
      { this.despachoModel,
       this.onTab,
       this.enviarPostular,
       this.isChatDespacho,this.distanceDispatch});

  final DespachoModel despachoModel;
  final bool isChatDespacho;
  final double distanceDispatch;
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(despachoModel.nombres,
                style: TextStyle(fontSize: 15,fontFamily: 'GoldplayRegular', color: Colors.blueGrey)),
            SizedBox(height: 4),
            Text("Propina: "+despachoModel.propina.toString(),
                style: TextStyle(
                  fontSize: 13, 
                  fontFamily: 'GoldplayRegular',
                  color: Color.fromARGB(255, 34, 30, 117), 
                  fontWeight: FontWeight.w700)),
                SizedBox(height: 4),
                 Text("A ${distanceDispatch.toStringAsFixed(2)} Km del envio",style: TextStyle(
                  fontSize: 13, 
                  fontFamily: 'GoldplayRegular',
                  color: Color.fromARGB(255, 34, 30, 117), 
                  fontWeight: FontWeight.w700)),
                  SizedBox(height: 4),
                 Text("Costo de envio: S/.${despachoModel.costoEnvio.toStringAsFixed(2)}",style: TextStyle(
                  fontSize: 16, 
                  fontFamily: 'GoldplayRegular',
                  color: Color.fromARGB(255, 34, 30, 117), 
                  fontWeight: FontWeight.w700)),
