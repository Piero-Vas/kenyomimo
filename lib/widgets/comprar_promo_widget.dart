...
class _ComprarPromoWidgetState extends State<ComprarPromoWidget> {
  ...
  Widget _tarjeta(BuildContext context, PromocionModel promocion) {
    final tarjeta = Card(
        ...
        child: Container(
          decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(30.0), border: Border.all(color: prs.colorGrisBordes)),
          width: 330.0,
          child: Stack(
            children: <Widget>[
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Flexible(
                        // child: Text('-20%',
                        child: Text('',
                            style: TextStyle(color: prs.colorRojo, fontSize: 14 ),
              ...
              children: [
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Text('S/. ' +  promocion.precio.toStringAsFixed(2),
                        style:
