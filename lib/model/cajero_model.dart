...
class CajeroModel {
  ...
  get acronimoSucursal {
    List<String> acronimos = sucursal.toString().trim().split(' ');
    String first = acronimos.first.substring(0, 1);
  ...
  Map<String, dynamic> toJson() =>
      {"id_agencia": idAgencia, "costo_envio": costoEnvio,"img": img, "tiempo_viaje": tiempo_viaje,
      "isTarjeta": isTarjeta,"idSucursal": idSucursal,"sucursal": sucursal,"costo_km_recorrido": costo_km_recorrido,"alias":alias};

  get string{
    return this.aCobrar.toString()+"-"+this.idCash.toString()+"-"+this.costoEnvio.toString()+"-"+this.img.toString()+"-"+this.sucursal.toString()+"-"+this.propina.toString()+"-"
    +this.lt.toString()+"-"+this.lg.toString()+"-"+this.idCompra.toString()+"-"+this.costo.toString()+"-"+this.idCajero.toString()+"-//"+this.typePayment.toString()+"-"+this.chargeId+"-"+this.alias.toString();
  }
}